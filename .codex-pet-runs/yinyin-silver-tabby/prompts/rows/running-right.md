Create one horizontal animation strip for Codex pet `yinyin`, state `running-right`.
...
Identity: same pet in every frame: A cute silver shaded cat, compact whole-body mascot silhouette, round face, plush soft gray-white gradient fur, subtle dark-tipped silver tabby shading, bright gentle eyes, tiny pink nose, no collar, no props, consistent markings and proportions across all animation states.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `sticker`: Polished sticker mascot with bold clean shapes, crisp outline, flat colors, and minimal highlight detail. User style notes: Soft sticker-like mascot style, clean outline, readable at 192x208, no text, no scenery, flat chroma-key background..
